...
import com.example.dianastore.adapter.AdapterBank
...
class PembayaranActivity : AppCompatActivity() {
    ...
    private fun displayBank() {
        ...
        arrBank.add(Bank("BCA", "8365259743", "Davit", R.drawable.logo_bca))
        arrBank.add(Bank("BRI", "8365259743", "Davit", R.drawable.logo_bri))
        arrBank.add(Bank("Mandiri", "8365259743", "Davit", R.drawable.logo_madiri))
