...
class AdapterKeranjang(var activity: Activity, var data: ArrayList<TabelKeranjang>, var listener: Listeners) : RecyclerView.Adapter<AdapterKeranjang.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.tvHarga.text = Helper().convertRupiah(harga * produk.jumlah)
        ...
        holder.btnTambah.setOnClickListener {
            ...
            holder.tvJumlah.text = jumlah.toString()
            holder.tvHarga.text = Helper().convertRupiah(harga * jumlah)
        }
    ...
    private fun update(data: TabelKeranjang) {
    ...
    private fun delete(data: TabelKeranjang) {
        val myDb = MyDatabase.getInstance(activity)
